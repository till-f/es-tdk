...
Std_ReturnType Rte_Start(void){
	...
	SetRelAlarm(TaskRunnableSlot1, TASKSLOT1_TICK_OFFSET, TASKSLOT1_TICK_CYCLE);
#endif
#ifdef TASKSLOT2_ACTIVE
	SetRelAlarm(TaskRunnableSlot2, TASKSLOT2_TICK_OFFSET, TASKSLOT2_TICK_CYCLE);
#endif
#ifdef TASKSLOT3_ACTIVE
	SetRelAlarm(TaskRunnableSlot3, TASKSLOT3_TICK_OFFSET, TASKSLOT3_TICK_CYCLE);
#endif

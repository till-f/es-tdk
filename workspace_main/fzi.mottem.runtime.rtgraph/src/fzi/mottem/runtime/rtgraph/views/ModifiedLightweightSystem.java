 ...
 * </ol>
 *//*
public class ModifiedLightweightSystem {
	...
	*//**
	 ...
	 * @since 2.0
	 *//*
	public ModifiedLightweightSystem(Canvas c) {
		this();
		setControl(c);
	}
	...
	*//**
	 ...
	 *//*
	public ModifiedLightweightSystem() {
		init();
	}
	...
	protected void addListeners() {
		...
		canvas.addControlListener(new ControlAdapter() {
			public void controlResized(ControlEvent e) {
				ModifiedLightweightSystem.this.controlResized();
			}
		});
		canvas.addListener(SWT.Paint, new Listener() {
			public void handleEvent(Event e) {
				ModifiedLightweightSystem.this.paint(e.gc);
			}
		});
	}
	...
	*//**
	...
	protected class RootFigure extends Figure {
		...
		*//** @see IFigure#getUpdateManager() *//*
		public UpdateManager getUpdateManager() {
			return ModifiedLightweightSystem.this.getUpdateManager();
		}
		...
		*//**
		...
		public boolean isMirrored() {
			return (ModifiedLightweightSystem.this.canvas.getStyle() & SWT.MIRRORED) != 0;
		}

...
public class CodeModelUiModule extends EmfUiModule
{

    public CodeModelUiModule(AbstractUIPlugin plugin)
    {
        super(plugin);
    }
    ...
    {
        binder.bind(IURIEditorOpener.class).annotatedWith(LanguageSpecific.class).to(CodemodelEditorOpener.class);
    }

...
|   vxlapi.h
| Project:
|   Multi Bus driver for WinXP/Vista/Windows7
|
| Description:
|   Driver Interface Prototypes - customer version
|
|-----------------------------------------------------------------------------
| $Author: vismra $    $Date: 2012-12-12 14:57:41 +0100 (Mi, 12 Dez 2012) $   $Revision: 20913 $
| $Id: vxlapi.h 20913 2012-12-12 13:57:41Z vismra $
|-----------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
/// predefined transceiver hardware revisions
//------------------------------------------------------------------------------
...
#define XL_CAN_MSG_FLAG_OVERRUN       0x02           //!< Overrun in Driver or CAN Controller, 
                                                     ...
                                                     //!<  -> OBSOLETE in driver/XLAPI V8.3 or newer!
                                                     //!<   -> Use XL_EVENT_FLAG_OVERRUN instead!
...
#define XL_EVENT_FLAG_OVERRUN         0x01           //!< Used in XLevent.flags (in driver/XLAPI V8.3 or newer)
...
typedef struct s_xl_daio_trigger_mode {
  ...
  unsigned int triggerType;     //!< Use defines XL_DAIO_TRIGGER_TYPE_xxx
